...
export function CancelBookingButton({ scheduleId }: { scheduleId: string }) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="mt-2 text-[10px] font-bold text-red-500 hover:text-red-700 hover:bg-red-50 border border-red-200 px-2.5 py-1 rounded-lg transition disabled:opacity-50 flex items-center gap-1"
    >
      {loading ? (
        "Membatalkan..."
      ) : (
